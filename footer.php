    ...
    <div class="footer-top a-up">
        <div class="container">
            ...
            <?php if( $social['instagram'] ) : ?>
                <a href="<?php echo $social['instagram']; ?>" class="footer-social" id="footer-social__insta">
            ...
            <?php if( $social['linkedin'] ) : ?>
                <a href="<?php echo $social['linkedin']; ?>" class="footer-social" id="footer-social__linkedin">
                    <svg width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
